        ...
        <form method="post" action="" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <?php if (isset($_POST['nick_name'])): ?>
              <input type="text" name="nick_name" class="form-control" placeholder="例： Seedkun" value="<?php echo htmlspecialchars($_POST['nick_name'], ENT_QUOTES, 'UTF-8'); ?>">
          <?php else: ?>
          <input type="nick_name" name="nick_name" class="form-control" placeholder="例： seedkun" value="">
          <?php endif; ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <?php if (isset($_POST['password'])): ?><input type="password" name="password" class="form-control" placeholder="" value="<?php echo htmlspecialchars($_POST['password'], ENT_QUOTES, 'UTF-8'); ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <?php if (isset($error['picture_path']) && $eroor['picture_path'] == 'type'): ?>
